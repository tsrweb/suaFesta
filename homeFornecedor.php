...
if ($con2->num_rows == 0) {
  ...
  echo '<script type="text/javascript">window.location=("cadastroFornecedor.php");</script>';
  die;
  };
...
<div class="container-fluid">
  ...
  <div class="col-sm-3 col-md-2 sidebar">
    <ul class="nav nav-pills nav-stacked">
            ...
            <li class="active"><a href="homeFornecedor.php?idFor=<?=$id?>">Home Fornecedor<span class="sr-only">(current)</span></a></li>
...
<a href="editarFornecedor.php"><button type="button" class="btn btn-danger">Editar</button></a>
    </div>
  </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="row">
        ...
        <h2>Contato</h2>
            <form class="form-inline" method="post" action="enviarMensagem.php?<?='idFesta='.$idFesta.'&idFor='.$idFor.''?>">
              <div class="form-group">
                <label for="exampleInputName2">De:</label>
                <input type="text" class="form-control" id="exampleInputName2" name="msgDe" value="<?=$logado?>" readonly>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail2">De:</label>
                <input type="email" class="form-control" id="exampleInputEmail2" name="msgPara" value="<?=$nomeEmpresa?>" readonly>
              </div><br /><br />
              <strong>Menssagem: </strong><br />
              <textarea class="form-control" rows="10" cols="100" name="msg"></textarea><br /><br />
